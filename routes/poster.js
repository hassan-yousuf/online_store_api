...
router.post('/', asyncHandler(async (req, res) => {
    try {
        uploadPosters.single('img')(req, res, async function (err) {
            ...
            let imageUrl = 'no_url';
            if (req.file) {
                imageUrl = `https://online-store-api-4d2f1b18bbb3.herokuapp.com/image/poster/${req.file.filename}`;
            }
...
router.put('/:id', asyncHandler(async (req, res) => {
    try {
        ...
        uploadPosters.single('img')(req, res, async function (err) {
            ...
            if (req.file) {
                image = `https://online-store-api-4d2f1b18bbb3.herokuapp.com/image/poster/${req.file.filename}`;
            }
