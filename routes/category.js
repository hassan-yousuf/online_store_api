...
//             let imageUrl = 'no_url';
//             if (req.file) {
//                 imageUrl = `https://online-store-api-4d2f1b18bbb3.herokuapp.com/image/category/${req.file.filename}`;
//             }
...
//             if (req.file) {
//                 image = `https://online-store-api-4d2f1b18bbb3.herokuapp.com/image/category/${req.file.filename}`;
//             }
...
// Create a new category with image upload
router.post('/', uploadCategory, asyncHandler(async (req, res) => {
  const { name } = req.body;
...
// Update a category
router.put('/:id', uploadCategory, asyncHandler(async (req, res) => {
  const { name } = req.body;
